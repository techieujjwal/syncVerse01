...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const CUSTOM_SRC =
      "https://files.bpcontent.cloud/2025/11/01/20/20251101201231-4LQ29P7C.js";
  ...
  return (
    <div className={`${dark ? "dark" : ""}`}>
      ...
      <main className="relative z-10 min-h-screen text-slate-100 overflow-hidden">
        ...
        {/* === PREMIUM BUTTON USING INTERACTIVE COMPONENT === */}
                ...
                >
                  ...
                  <Link to="/experts">
                    <Button
                      size="lg"
                      variant="outline"
                      className="px-6 py-3 border-white/10 text-white/90 bg-red-500"
                    >
                      An Expert ?
                    </Button>
                  </Link>
                    ...
                    <div className="flex -space-x-3">
                      {community.map((c) => (
                        <motion.div
                          ...
                          className="w-10 h-10 rounded-full ring-2 ring-white/8 flex items-center justify-center"
                        >
                          <div
