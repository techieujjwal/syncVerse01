          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              >
                ...
                >
                  From curated roadmaps to hands-on programs and a buzzing
                  community — everything designed to get you from zero to
                  product-ready.
                </motion.p>
                ...
                >
                  ...
                  <Link to="/programs">
                    <Button
                      size="lg"
                      variant="outline"
                      className="px-6 py-3 border-white/10 text-white/90"
                    >
                      View Programs
                    </Button>
                  </Link>
                  ...
                  <div className="ml-2 text-sm text-white/60">
                    ...
                    <span className="font-medium">Commitment:</span> 6–10
                    hrs/week
                  </div>
                </motion.div>
              </motion.div>
            ...
            >
              <NeonGradientCard
                borderSize={2}
                borderRadius={20}
                neonColors={{ firstColor: "#ff00ff", secondColor: "#00ffff" }}
                className="relative overflow-hidden p-[2px] rounded-[20px] shadow-[0_0_25px_rgba(0,255,255,0.2)]"
              >
                <div className="rounded-[18px] bg-black/90 px-6 py-6 md:px-8 md:py-8">
                  ...
                  <div className="flex items-center gap-4 mb-5">
                    <div className="flex -space-x-3">
                      {community.map((c) => (
                        <motion.div
                          ...
                          className="w-10 h-10 rounded-full ring-2 ring-white/10 flex items-center justify-center"
                        >
                          <div
                            className={`w-full h-full rounded-full bg-gradient-to-br ${c.color} flex items-center justify-center text-black/80`}
                          >
                            {c.initials}
                          </div>
                        </motion.div>
                    ...
                    <div className="text-sm text-white/60">
                      1.2k learners · 98% completion
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-md p-3 bg-[#111]/80">
        ...
        <section className="pb-20" aria-label="Features">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              >
                A unified experience — curated roadmaps, collaborative learning,
                and placement-driven programs.
              </motion.p>
                ...
                {[
                  {
                    ...
                    details:
                      "Curated resources, checkpoints, and mini-projects to keep you on track.",
                  },
                  {
                    ...
                    details:
                      "Study groups, pair programming, and mentor office hours included.",
                  },
                  {
                    ...
                    details:
                      "Placement kits, interview practice, and project reviews to help you land roles.",
                  },
                ].map((f, i) => (
        ...
        <footer className="py-12">
          <div className="container mx-auto px-6">
            <div className="bg-white/4 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                ...
                <div className="text-sm text-white/70">
                  Join cohorts, build projects, and get pro feedback.
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link to="/programs">
                  <Button
                    variant="outline"
                    className="px-5 py-3 border-white/10 text-white/90"
                  >
                    See programs
                  </Button>
                </Link>
            ...
            <div className="mt-6 text-xs text-white/50 text-center">
              © {new Date().getFullYear()} TechPath · Crafted with ❤️ for
              learners
            </div>
          </div>
        </footer>
